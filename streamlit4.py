...
model = torch.hub.load('ultralytics/yolov5', 'custom', path=R"C:\Users\dharm\OneDrive\Desktop\TEAM L3D\yolov5\yolov5\runs\train\vehicle_model_v1\weights\best.pt", force_reload=True)
